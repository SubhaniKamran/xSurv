                  ...
                  <tbody>
                    @foreach($notification_setting as $setting)
                      <tr>
                        ...
                        <td>
                          @if($setting->status == 1)
                            <a href="{{url('company/notification/setting/disable/'. $setting->id)}}"><button class="btn btn-danger">Disable</button></a>
                          @else
                            <a href="{{url('company/notification/setting/enable/'. $setting->id)}}"><button class="btn btn-success">Enable</button></a>
                          @endif
                        </td>
                      </tr>
                    @endforeach
