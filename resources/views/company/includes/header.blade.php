        ...
        <ul class="list-unstyled topbar-nav float-right mb-0">
            <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-lg pt-0">
                    ...
                    <!-- All-->
                    <a href="{{url('company/all/notifications')}}" class="dropdown-item text-center text-primary">
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="{{url('company/profile/create')}}"><i class="ti-user te9"></i>&nbsp;&nbsp;Profile</a>
                    <div class="dropdown-divider mb-0"></div>
                    <a class="dropdown-item" href="{{ route('logout') }}"
                       onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="ti-power-off text-muted mr-2"></i>{{ __('Logout') }}
                    </a>
