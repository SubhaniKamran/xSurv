        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 text-center">
                    @if($status == 1)
                        <center><p class="description pt-2">{{$company}} have purchase <strong>{{$packageName}}</strong> package. Thanks!</p></center>
                    @else
                        <center><p class="description pt-2">You have purchase <strong>{{$packageName}}</strong> package. If you have question, feel free to contact us. Thanks!</p></center>
                    @endif
                </div>
                <div class="col-md-2 text-center"></div>
            </div>
